...
export const TIMELINE_ERAS: TimelineEra[] = [
  ...
  },
  {
    ...
    startYear: 319,
    endYear: 550,
    representativeImage: '/images/nalanda.jpg',
    ...
    milestones: [
      {
        ...
        relatedExhibit: {
          ...
          has3D: true,
          shortDescription: 'Interactive 3D architectural model of the world-heritage Buddhist university ruins.',
        },
      },
      {
  ...
  },
  {
    ...
    startYear: 1858,
    endYear: 1947,
    representativeImage: '/images/dandi-march.jpg',
    ...
    milestones: [
      ...
      },
      {
        ...
        relatedExhibit: {
          ...
          image: '/images/dandi-march.jpg',
          has3D: true,
          shortDescription: 'Interactive 3D model of the historic Salt March tableau commemorating civil defiance.',
        },
      },
      {
        id: 'ms-bhagat-singh',
    ...
    milestones: [
      {
        ...
        relatedExhibit: {
          ...
          title: 'Parliament House & Constitution',
          image: '/images/parliament.jpg',
          has3D: true,
          shortDescription: 'Interactive 3D model of Parliament House, New Delhi, cradle of Indian constitutional democracy.',
        },
      },
      {
